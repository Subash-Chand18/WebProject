...
.order-header {
    background: linear-gradient(135deg, #54ba4e, #a5e4a2);
    color: white;
    padding: 20px 30px;
    font-weight: 600;
    font-size: 1.1rem;
...
.summary-item {
    ...
    box-shadow: 0 2px 8px rgba(33, 94, 71, 0.1);
...
.summary-item:hover {
    ...
    box-shadow: 0 4px 12px rgba(33, 94, 71, 0.2);
}
...
.summary-item:last-child {
    ...
    border: 2px solid #43a13a;
}

.summary-item:last-child:hover {
    transform: scale(1.04);
    box-shadow: 0 6px 16px rgba(84, 186, 78, 0.6);
}
