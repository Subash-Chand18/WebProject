...
// Fetch orders (excluding soft-deleted ones)
$sql = "
    SELECT 
            ...
            <tr>
                ...
                <td>
                    <form method="POST" action="Adminorders.php" class="d-flex align-items-center gap-2">
                        ...
                        <select name="order_status" class="form-select status-select" onchange="confirmCancel(this)">
                            <?php 
...
function confirmCancel(selectElement) {
    ...
    if (selectedValue === 'Cancelled') {
        const confirmed = confirm("Do you want to cancel and hide this order (soft delete)?");
        form.querySelector('input[name="confirmed_cancel"]').value = confirmed ? '1' : '0';
    } else {
