...
<script>
    ...
    document.querySelectorAll('.sidebar-link, .topnav-menu .nav-link').forEach(link => {
        link.addEventListener('click', function() {
            document.querySelectorAll('.sidebar-link, .topnav-menu .nav-link').forEach(el => el.classList.remove('active'));
